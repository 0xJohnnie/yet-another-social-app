...
import { IconCheck, IconCopy, IconHome, IconWallet } from '@tabler/icons-react';
...
function MainAppShell({ children }: { children: React.ReactNode }) {
  ...
  const publicURL: NavbarURLs[] = [
    ...
    },
    {
      ...
      webURL: `https://app.safe.global/transactions/history?safe=matic:${safeSelected}`,
      icon: <IconWallet size={_iconSize} stroke={1.5} />,
      showButton: safeSelected.length > 0,
      target: '_blank',
    },
  ];
      ...
      >
              ...
              {screenWidth > 575 &&
                ...
                safeSelected.length > 0 && (
                  <Stack id="walletInfo" align="flex-end" gap={0}>
                    ...
                    <CopyButton value={safeSelected} timeout={1000}>
                      {({ copied, copy }) => (
                        <Tooltip
                          label={copied ? 'Copied' : 'Copy your wallet address'}
                          withArrow
                          position="right"
                        >
                          <ActionIcon
                          ...
                          >
                            ...
                            >
                              <Title order={5}>
                                {shortenWalletAddress(safeSelected)}
                              </Title>
                              {copied ? (
        ...
        <AppShell.Main>
          <Stack m={8} h={screenHeight - 300}>
            {children}
            {
              <Stack h={'100%'} justify="center" id="mainbodycontent">
